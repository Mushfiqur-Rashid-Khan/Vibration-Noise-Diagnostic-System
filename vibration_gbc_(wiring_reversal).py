# -*- coding: utf-8 -*-
"""Vibration_GBC (Wiring Reversal).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Lr0LbJJzpj9ct9UE-Eg11ZXKj3iLRcxA
"""
...
plt.title('SGBoost (Wiring Reversal)')
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('XGBoost (Wiring Reversal)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Cost-Sensitive LightGBM (Wiring Reversal)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Hybrid LightGBM (Wiring Reversal)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('CatBoost (Wiring Reversal)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('NGBoost (Wiring Reversal)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
X = df.iloc[:, :-8]
y = df.iloc[:, -8].astype(str)  # Convert labels to strings for TFDF
...
plt.title('TensorFlow Gradient Boosted Trees (Wiring Reversal)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
plt.title("GBDT++ (Wiring Reversal)")
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.tight_layout()
plt.show()
