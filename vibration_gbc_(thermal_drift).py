# -*- coding: utf-8 -*-
"""Vibration_GBC (Thermal Drift).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1266pFi3cZJtmUCss4DF223MneQYvx33h
"""
...
plt.title('SGBoost (Thermal Drift)')
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('XGBoost (Thermal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Cost-Sensitive LightGBM (Thermal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Hybrid LightGBM (Thermal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('CatBoost (Thermal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('NGBoost (Thermal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
X = df.iloc[:, :-5]
y = df.iloc[:, -5].astype(str)  # Convert labels to strings for TFDF
...
plt.title('TensorFlow Gradient Boosted Trees (Thermal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
