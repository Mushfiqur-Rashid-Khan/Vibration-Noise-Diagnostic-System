# -*- coding: utf-8 -*-
"""Vibration_GBC (Gas Leakage).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AsTe6YRGE2F2sMYXssd_WCK14LZwdFwP
"""
...
plt.title('SGBoost (for Gas Leakage)')
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Gas Leakage'], yticklabels=['No', 'Gas Leakage'])
plt.title('XGBoost (for Gas Leakage)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', cbar=True,
            xticklabels=['No', 'Gas Leakage'], yticklabels=['No', 'Gas Leakage'])
plt.title('Cost-Sensitive LightGBM (for Gas Leakage)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Gas Leakage'], yticklabels=['No', 'Gas Leakage'])
plt.title('Hybrid LightGBM (Gas Leakage)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', cbar=True,
            xticklabels=['No', 'Gas Leakage'], yticklabels=['No', 'Gas Leakage'])
plt.title('CatBoost (Gas Leakage)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
X = df.iloc[:, :-2]
y = df.iloc[:, -2].astype(str)  # Convert labels to strings for TFDF
...
cm = confusion_matrix(y_test, y_pred)
plt.figure(figsize=(8, 6))
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', xticklabels=['No', 'Gas Leakage'], yticklabels=['No', 'Gas Leakage'])
plt.title('TensorFlow Gradient Boosted Trees (Gas Leakage)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
class_labels = sorted(y.unique())
plt.figure(figsize=(8, 6))
sns.heatmap(cm, annot=True, fmt='d', cmap='YlGnBu', xticklabels=['No', 'Gas Leakage'], yticklabels=['No', 'Gas Leakage'])
plt.title("GBDT++ (Gas Leakage)")
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.tight_layout()
plt.show()
