# -*- coding: utf-8 -*-
"""Vibration_GBC (Radiation Induced Degradation).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1D3ZM9U3ppZH9vF5Svfd94Y9JTIqFsMIh
"""
...
plt.title('SGBoost (Radiation-Induced Degradation)')
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('XGBoost (Radiation-Induced Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Cost-Sensitive LightGBM (Radiation-Induced Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Hybrid LightGBM (Radiation-Induced Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('CatBoost (Radiation Induced Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('NGBoost (Radiation Induced Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
X = df.iloc[:, :-4]
y = df.iloc[:, -4].astype(str)  # Convert labels to strings for TFDF
...
plt.title('TensorFlow Gradient Boosted Trees (Radiation Induced Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
plt.title("GBDT++ (Radiation Induced Degradation)")
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.tight_layout()
plt.show()
