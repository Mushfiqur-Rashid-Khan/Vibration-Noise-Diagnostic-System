# -*- coding: utf-8 -*-
"""Vibration_GBC (Signal Drift).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1NWdcyv7irOlQLo7oSMYuPXgakAZCxUW8
"""
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', cbar=True,
            xticklabels=['No', 'Signal Drift'], yticklabels=['No', 'Signal Drift'])
plt.title('SGBoost (for Signal Drift)')
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Signal Drift'], yticklabels=['No', 'Signal Drift'])
plt.title('XGBoost (for Signal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', cbar=True,
            xticklabels=['No', 'Signal Drift'], yticklabels=['No', 'Signal Drift'])
plt.title('Cost-Sensitive LightGBM (for Signal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Signal Drift'], yticklabels=['No', 'Signal Drift'])
plt.title('Hybrid LightGBM (Signal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', cbar=True,
            xticklabels=['No', 'Signal Drift'], yticklabels=['No', 'Signal Drift'])
plt.title('CatBoost (for Signal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', cbar=True,
            xticklabels=['No', 'Signal Drift'], yticklabels=['No', 'Signal Drift'])
plt.title('NGBoost (for Signal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
X = df.iloc[:, :-1]
y = df.iloc[:, -1].astype(str)  # Convert labels to strings for TFDF
...
cm = confusion_matrix(y_test, y_pred)
plt.figure(figsize=(8, 6))
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', xticklabels=['No', 'Signal Drift'], yticklabels=['No', 'Signal Drift'])
plt.title('TensorFlow Gradient Boosted Trees (for Signal Drift)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
plt.title("GBDT++ (for Signal Drift)")
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.tight_layout()
plt.show()
