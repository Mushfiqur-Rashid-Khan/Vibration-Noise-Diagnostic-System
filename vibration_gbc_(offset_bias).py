# -*- coding: utf-8 -*-
"""Vibration_GBC (Offset Bias).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/176wSOYAzKWrLZLSUYLNHFaqCTg-VV_85
"""
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Cost-Sensitive LightGBM (Offset Bias)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Hybrid LightGBM (Offset Bias)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('CatBoost (Offset Bias)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
X = df.iloc[:, :-7]
y = df.iloc[:, -7].astype(str)  # Convert labels to strings for TFDF
...
plt.title('TensorFlow Gradient Boosted Trees (Offset Bias)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
