# -*- coding: utf-8 -*-
"""Vibration_GBC (Sensor Aging / Degradation).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1eHL3wNAp3qMqaJP-95NSw7Wyc8eP6uwB
"""
...
plt.title('SGBoost (Sensor Aging / Degradation)')
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('XGBoost (Sensor Aging / Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Cost-Sensitive LightGBM (Sensor Aging / Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Greens', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('Hybrid LightGBM (Sensor Aging / Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('CatBoost (Sensor Aging / Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', cbar=True,
            xticklabels=['No', 'Yes'], yticklabels=['No', 'Yes'])
plt.title('NGBoost (Sensor Aging / Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
X = df.iloc[:, :-6]
y = df.iloc[:, -6].astype(str)  # Convert labels to strings for TFDF
...
plt.title('TensorFlow Gradient Boosted Trees (Sensor Aging / Degradation)')
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.show()
...
plt.title("GBDT++ (Sensor Aging / Degradation)")
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.tight_layout()
plt.show()
